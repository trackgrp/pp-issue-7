...
module.exports = env => {
    ...
    const config = {
        ...
        resolve: {
            ...
            alias,
            // TrackGroup: custom-code-needed
            // symlinks need to be turned off for our shared code to work
            symlinks: false
        },
        resolveLoader: {
            // TrackGroup: custom-code-needed
    ...
    // TrackGroup: custom-code-needed
    // This adds auto-linting support to our builds
    if (!env.release) {
      config.module.rules.push({
          ...
          options: {
              ...
              fix: true,
              cache: true,
              quiet: true, // don't display warnings, printing them to console is too slow
              extends:  [
